...
>
  <svg
    fill={currentRoute === "/telemedicine/category" ? "#your-active-color" : "#ede8e8"}
    width="25"
    height="30"
    viewBox="-7.5 0 32 32"
    xmlns="http://www.w3.org/2000/svg"
    className={`svg-icon ${
      currentRoute === "/telemedicine/category" ? "svg-icon-active" : ""
    }`}
  >
...
>
  <svg
    fill={currentRoute === "/homecare" ? "#your-active-color" : "#ede8e8"}
    width="20"
    height="25"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
...
>
  <svg
    fill={currentRoute === "/pharmacy/category" ? "#your-active-color" : "#ede8e8"}
    width="20"
    height="25"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
  ...
  <span class="ms-3">Pharmacy</span>
          ...
          <li>
            ...
            >
             <svg  fill="#ede8e8" width="20" height="25" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" ><g id="SVGRepo_bgCarrier" strokeWidth={0} /><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" /><g id="SVGRepo_iconCarrier"><defs><style dangerouslySetInnerHTML={{__html: ".cls-1{fill:none;stroke:#ede8e8;stroke-miterlimit:10;stroke-width:1.92px;}" }} /></defs><path className="cls-1" d="M3.38,1.46h0A5.75,5.75,0,0,1,9.13,7.21v8.63a0,0,0,0,1,0,0H3.38a0,0,0,0,1,0,0V1.46A0,0,0,0,1,3.38,1.46Z" /><polyline className="cls-1" points="3.38 23.5 3.38 15.83 7.21 15.83 7.21 23.5" /><polyline className="cls-1" points="14.88 23.5 14.88 11.04 18.71 11.04 18.71 23.5" /><path className="cls-1" d="M13,7.21h7.67a0,0,0,0,1,0,0v1A2.87,2.87,0,0,1,17.75,11H15.83A2.88,2.88,0,0,1,13,8.17v-1A0,0,0,0,1,13,7.21Z" /><line className="cls-1" x1="16.79" y1="0.5" x2="16.79" y2="7.21" /><line className="cls-1" x1="12.96" y1="0.5" x2="12.96" y2="7.21" /><line className="cls-1" x1="20.63" y1="0.5" x2="20.63" y2="7.21" /></g></svg>
          ...
          <li>
            ...
            >
          <svg fill="#000000"  width="30" height="25" viewBox="0 0 24 24" id="exchange-dollar" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" className="icon flat-line"><g id="SVGRepo_bgCarrier" strokeWidth={0} /><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" /><g id="SVGRepo_iconCarrier"><path id="primary" d="M20,12a7.91,7.91,0,0,0-.35-2.35,8,8,0,0,0-14.35-2" style={{fill: 'none', stroke: '#ede8e8', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2}} /><path id="primary-2" data-name="primary" d="M4,12a7.91,7.91,0,0,0,.35,2.35,8,8,0,0,0,14.35,2" style={{fill: 'none', stroke: '#ede8e8', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2}} /><polyline id="primary-3" data-name="primary" points="19 11 20 12 21 11" style={{fill: 'none', stroke: '#ede8e8', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2}} /><polyline id="primary-4" data-name="primary" points="5 13 4 12 3 13" style={{fill: 'none', stroke: '#ede8e8', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2}} /><path id="primary-5" data-name="primary" d="M10,15h2.5A1.5,1.5,0,0,0,14,13.5h0A1.5,1.5,0,0,0,12.5,12h-1A1.5,1.5,0,0,1,10,10.5h0A1.5,1.5,0,0,1,11.5,9H14" style={{fill: 'none', stroke: '#ede8e8', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2}} /><path id="primary-6" data-name="primary" d="M12,9V8m0,8V15" style={{fill: 'none', stroke: '#ede8e8', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2}} /></g></svg>
          ...
          <li className="pt-24">
            ...
            >
             <svg width="30" height="25"  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M15 12L2 12M2 12L5.5 9M2 12L5.5 15" stroke="#d41633" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M9.00195 7C9.01406 4.82497 9.11051 3.64706 9.87889 2.87868C10.7576 2 12.1718 2 15.0002 2L16.0002 2C18.8286 2 20.2429 2 21.1215 2.87868C22.0002 3.75736 22.0002 5.17157 22.0002 8L22.0002 16C22.0002 18.8284 22.0002 20.2426 21.1215 21.1213C20.3531 21.8897 19.1752 21.9862 17 21.9983M9.00195 17C9.01406 19.175 9.11051 20.3529 9.87889 21.1213C10.5202 21.7626 11.4467 21.9359 13 21.9827" stroke="#d41633" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
